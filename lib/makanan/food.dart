...
static List<Food> getFoods() {
  ...
  Food(name: 'Sayuran', 
      ...
      description:"Sayur-sayuran termasuk dalam jenis makanan sehat karena mengandung banyak nutrisi penting, seperti serat, vitamin A, vitamin C, vitamin K, magnesium, kalsium, zat besi, folat, dan kalium, yang sangat baik untuk kesehatan.\n"
  ...
  Food(name: 'Buah-Buahan', 
      image: 'images/buah.jpg', 
      description:"Buah-buahan boleh dimakan sehari-hari karena mereka kaya akan nutrisi seperti vitamin, mineral, serat, dan antioksidan yang baik untuk kesehatan tubuh. Mengonsumsi buah-buahan secara teratur dapat meningkatkan sistem kekebalan, menjaga keseimbangan gula darah, dan membantu menjaga berat badan yang sehat."),
  
  Food(name: 'Daging dan Telur', 
      image: 'images/daging.jpg', 
      description:"Daging adalah salah satu sumber protein hewani yang penting dalam diet manusia. Daging mengandung berbagai nutrisi penting seperti protein, zat besi, zinc, vitamin B kompleks, dan asam amino esensial yang dibutuhkan oleh tubuh untuk menjalankan berbagai fungsi penting.\n"
  ...
  Food(name: 'Kacang-kacangan dan Biji-bijian', 
      image: 'images/kacang.jpg', 
      description:"Kacang adalah makanan yang sehat dan dapat dimakan sehari-hari karena mengandung berbagai manfaat kesehatan seperti sumber protein, serat, nutrisi, lemak sehat, antioksidan, dan menurunkan resiko penyakit.\n"
